...
export default function Content() {
    ...
    return (
        <div className="w-full flex justify-center flex-wrap mb-[70px] md:mb-5">
            ...
            <div className="w-full h-[50vh] hidden md:flex">
                <Slider />
            </div>
            ...
            <div className="w-full flex justify-center items-center filter">
                <ul className="w-[80%] flex justify-center content-center md:items-center flex-wrap md:flex-nowrap mt-8 mb-8">
                    <li data-statuse="لپ تاپ و الترابوک" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 rounded-t-[7px] md:rounded-[7px] hover:bg-white duration-300 bg-[#eedac3] cursor-pointer">
                    ...
                    <li data-statuse="تبلت" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#cce0ec] cursor-pointer">
                    ...
                    <li data-statuse="گوشی موبایل" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#dadbe8] cursor-pointer">
                    ...
                    <li data-statuse="هدفون، هدست و هندزفری" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#dfe2d7] cursor-pointer">
                    ...
                    <li data-statuse="ساعت هوشمند" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#d8d8f4] cursor-pointer">
                    ...
                    <li data-statuse="ماوس (موشواره)" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#eae1b8] cursor-pointer">
                    ...
                    <li data-statuse="کیبورد (صفحه کلید)" onClick={filter} className="h-[90px] w-full md:w-[130px] md:h-[130px] flex flex-wrap justify-center content-center grow m-0 md:m-2 md:rounded-[7px] hover:bg-white duration-300 bg-[#f0dbd5] cursor-pointer">
